    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          <img class="w-10 h-10 rounded-full" src="https://raw.githubusercontent.com/stilucky/my-web/main/avail_9429136-1.png" />
          <h1 class="flex-1 ml-3 text-2xl font-semibold dark:text-white">Stilucky<span class="text-primary">.eth</span></h1>
        </RouterLink>
        <div
